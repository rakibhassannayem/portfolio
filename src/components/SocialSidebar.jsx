...
const SocialSidebar = () => {
  ...
  return (
    <motion.div
      className="fixed left-8 bottom-0 hidden lg:flex flex-col items-center space-y-6 z-50"
    ...
    >
      ...
      {/* LinkedIn, StackOverflow, Twitter, Telegram icons similar to above with correct paths */}
       <motion.a
         variants={itemVariants}
         whileHover={{ scale: 1.2, y: -5 }}
         className="social-icon group"
